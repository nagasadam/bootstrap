...
<<<<<<< HEAD
      numBullets = 9,
=======
>>>>>>> 1bd7a258a700c39e8182db5d341f54178b9faf0f
      xAxis = d3.svg.axis();
...
>>>>>>> 1bd7a258a700c39e8182db5d341f54178b9faf0f
      ...
      axis.attr("transform", vertical ? null : "translate(0," + extentY + ")")
          .call(xAxis.scale(x1).tickFormat(d3.format("$, .2n")));
<<<<<<< HEAD
      }
...
=======
      ...
      if (i > 0)
      {
        axis.call(xAxis).selectAll("text").remove();
      }
>>>>>>> 1bd7a258a700c39e8182db5d341f54178b9faf0f
    });
    d3.timer.flush();
...
<<<<<<< HEAD
  bullet.numBullets = function(_) {
    if (!arguments.length) return numBullets;
    numBullets = _;
    return bullet;
  };
